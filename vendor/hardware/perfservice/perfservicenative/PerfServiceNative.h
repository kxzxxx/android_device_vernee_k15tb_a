...
extern void PerfServiceNative_runtimeBoostEnable(void);
extern void PerfServiceNative_runtimeBoostEnableTimeout(int timeout);
extern void PerfServiceNative_runtimeBoostDisable(void);
