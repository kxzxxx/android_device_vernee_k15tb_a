...
struct DSHWReg {
    ...
    uint16_t  tdshp_mid_softlimit_ratio;
    uint16_t  tdshp_mid_limit;
    uint16_t  tdshp_mid_bound;
    ...
    uint16_t  tdshp_high_softlimit_ratio;
    uint16_t  tdshp_high_limit;
    uint16_t  tdshp_high_bound;
    uint16_t  tdshp_high_coring_value;
    uint16_t  tdshp_high_softcoring_gain;

    uint16_t  edf_gain_en;
    uint16_t  edf_flat_gain;
    uint16_t  edf_detail_gain;
    uint16_t  edf_edge_gain;
    uint16_t  edf_clip_ratio_inc;
    uint16_t  edf_flat_th;
    uint16_t  edf_detail_rise_th;
    uint16_t  edf_detail_fall_th;
    uint16_t  edf_edge_th;
    uint16_t  edf_flat_slope;
    uint16_t  edf_detail_rise_slope;
    uint16_t  edf_detail_fall_slope;
    uint16_t  edf_edge_slope;
    uint16_t  edf_edge_mag_th;
    uint16_t  edf_edge_mag_slope;
    uint16_t  edf_edge_mono_th;
    uint16_t  edf_edge_mono_slope;
    uint16_t  edf_edge_trend_th;
    uint16_t  edf_edge_trend_slope;
    uint16_t  edf_edge_trend_flat_mag;
    uint16_t  edf_bld_wgt_trend;
    uint16_t  edf_bld_wgt_mono;
    uint16_t  edf_bld_wgt_mag;

    uint16_t  tdshp_cboost_lmt_u;
    uint16_t  tdshp_cboost_lmt_l;
    uint16_t  tdshp_cboost_en;
    uint16_t  tdshp_cboost_gain;
    uint16_t  tdshp_cboost_yconst;
    uint16_t  tdshp_cboost_yoffset_sel;
    uint16_t  tdshp_cboost_yoffset;
#endif
